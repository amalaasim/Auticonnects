...
useEffect(() => {
  ...
  const ensureSession = async () => {
    ...
    try {
      ...
      console.error("Failed to ensure shoe analytics session:", error);
    }
  };
...
useEffect(() => {
  updateWonderworldEmotionCounts("shoe", emotionCounts);
}, [emotionCounts]);

useEffect(() => {
  updateWonderworldFocusMetrics("shoe", getMetrics());
    ...
    >
      <Box sx={{ cursor: `url(${click}) 122 122, auto` }}>
        ...
        <Box sx={{ backgroundImage: `url(${favoriteCharacter === "bubbles" ? bubblesLearnBg : favoriteCharacter === "mimmi" || favoriteCharacter === "mimi" ? mimmiLearnBg : learnbg})`, width: "100vw", height: "100dvh", minHeight: "100dvh", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundAttachment: "fixed", position: "relative", backgroundPosition: favoriteCharacter === "mimmi" || favoriteCharacter === "mimi" ? "center calc(100% + 10cqh)" : "bottom center", overflow: "hidden", containerType: "size", "@media (min-width: 1200px) and (min-aspect-ratio: 3/2)": { backgroundPosition: favoriteCharacter === "mimmi" || favoriteCharacter === "mimi" ? "center calc(100% + 12cqh)" : "bottom center" }, "@media (min-width: 1000px) and (max-width: 1100px) and (min-height: 1300px)": { backgroundPosition: favoriteCharacter === "mimmi" || favoriteCharacter === "mimi" ? "center calc(100% + 09cqh)" : "bottom center" }, "@media (min-width: 1300px) and (max-width: 1400px) and (max-aspect-ratio: 1.4)": { backgroundPosition: favoriteCharacter === "mimmi" || favoriteCharacter === "mimi" ? "center calc(100% + 09cqh)" : "bottom center" } }}>
          ...
          <Box onClick={() => navigate("/yourShoe")} sx={{ position: "absolute", top: "5cqh", left: "5cqw", zIndex: 10, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", "&:hover": { transform: "scale(1.08)", transition: "0.2s" } }}>
          ...
          <Box sx={{ position: "absolute", right: "2cqw", bottom: "16cqh", width: "max(55cqw, 82cqh)", aspectRatio: "1024 / 796", "@media (max-aspect-ratio: 1.55)": { width: "max(65cqw, 92cqh)", right: "1cqw", bottom: "14cqh" }, "@media (min-width: 1160px) and (max-width: 1250px) and (min-height: 800px) and (max-height: 900px)": { bottom: "12cqh" }, "@media (min-width: 1000px) and (max-width: 1160px) and (max-height: 780px)": { bottom: "14cqh" }, "@media (min-width: 1300px) and (max-aspect-ratio: 1.4)": { width: "max(55cqw, 82cqh)", right: "2cqw", bottom: "12cqh" }, containerType: "size", zIndex: 4 }}>
            ...
            <Box component="img" src={ball} onClick={() => handleSelect(ball)} sx={{ position: "absolute", left: "19%", top: "24%", width: "14.5%", height: "auto", cursor: "pointer", zIndex: 5, "&:hover": { transform: "scale(1.12)" } }} />
            <Box component="img" src={shoe} onClick={() => handleSelect(shoe)} sx={{ position: "absolute", left: "41%", top: "20%", width: "22%", height: "auto", cursor: "pointer", zIndex: 5, "&:hover": { transform: "scale(1.12)" } }} />
            <Box component="img" src={car} onClick={() => handleSelect(car)} sx={{ position: "absolute", left: "68.2%", top: "23%", width: "19.5%", height: "auto", cursor: "pointer", zIndex: 5, "&:hover": { transform: "scale(1.12)" } }} />

            {[
              { text: t("ball"), left: "25%" },
              { text: t("shoes"), left: "53.5%" },
              { text: t("car"), left: "78%" },
            ].map((item) => (
            ...
            {selectedImageSrc && (
              <Box component="img" src={selectedImageSrc} sx={{ position: "absolute", left: "53%", top: "74%", width: selectedImageSrc === shoe ? "20%" : selectedImageSrc === ball ? "13%" : "16%", height: "auto", transform: "translate(-50%, -50%)", objectFit: "contain", zIndex: 6 }} />
            )}
          </Box>
          ...
          <audio ref={audioRef} src={i18n.language === "ur" ? findurdu : findshoe} preload="auto" />
