          ...
          <Box
            ...
            sx={{
              ...
              justifyContent: "center",
	              color: "#482406",
	              fontWeight: "900",
	                fontSize: previewImage ? "max(3cqw, 16px)" : "max(3.8cqw, 22px)",
	              fontFamily: i18n.language === "ur" ? "JameelNooriNastaleeq" :"Chewy",
              pointerEvents: "none",
...
return(
 ...
 >
    ...
    >
      ...
      {/* Blur layer now RELATIVE to the board image */}
      <Box
        sx={{
          position: "absolute",
          top: "46.4%",
      ...
      >
        ...
        >
          ...
          <Box sx={{ 
            ...
            <Box component='img' sx={{ width: "36%", height: "auto", objectFit: "contain", transform: "translateY(10%)" }} src={half} />
            <Box component='img' sx={{ width: "27%", height: "auto", objectFit: "contain", transform: "translate(-15%, -15%)" }} src={full} />
            <Box component='img' sx={{ width: "22%", height: "auto", objectFit: "contain", transform: "translateY(10%)" }} src={three} />
          </Box>
